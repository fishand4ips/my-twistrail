    ...
    actions: [
      {
        ...
        checked: true,
        name: "high",
        cellAttributes: { class: { fieldName: "serviceCaseQueueFiltered" } }
      },
      {
        label: "Medium",
        checked: false,
...
export default class ServiceCaseQueueFiltered extends NavigationMixin(
  ...
  wiredPicklistValues({ error, data }) {
    if (data) {
      ...
      this.errorMessage = `Failed to retrieve picklist values. ${this.reduceErrors(
        error
      )}`;
    }
  }
